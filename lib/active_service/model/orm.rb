  ...
  module Model
    ...
    module ORM
      ...
      def assign_errors(items)
        errors.clear
        items = self.class.attribute_map.map(items)
      ...
      module ClassMethods
        ...
        [:all, :includes, :where, :order, :create, :build, :find, :first, :last, :limit, :first_or_create, :first_or_initialize].each do |method|
